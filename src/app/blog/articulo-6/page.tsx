    ...
    return (
        ...
        <div className=" h-full w-fullh-full bg-green-100 flex items-center justify-center gap-5 flex-grow ">
            ...
            <div className=" flex flex-col m-5 gap-2 xl:gap-10">
                <h1 className=" text-4xl font-serif xl:text-4xl">Son animales muy pacíficos.</h1>
                <p className=" font-serif text-base xl:text-xl">Son conocidos por su comportamiento tranquilo y tolerante, lo que les permite interactuar con muchas otras especies. Los carpinchos son famosos por su tolerancia. A menudo se los ve relajados mientras aves, monos o incluso otros animales se les acercan o interactúan con ellos. Esto los convierte en símbolos de tranquilidad.</p>
