    ...
    return (
        ...
        <div className=" h-full w-fullh-full bg-green-100 flex items-center justify-center gap-5 flex-grow ">
            ...
            <div className=" flex flex-col m-5 gap-2">
                <h1 className=" text-4xl font-serif ">Son parientes cercanos de los conejillos de Indias.</h1>
                <p className=" font-serif text-base">Aunque mucho más grandes, están relacionados con estos pequeños roedores. Ambos pertenecen al orden Rodentia. Aunque las diferencias de tamaño son notables, comparten características genéticas y anatómicas, como sus incisivos en crecimiento continuo.</p>
